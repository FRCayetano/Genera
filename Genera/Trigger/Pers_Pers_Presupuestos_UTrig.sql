...
/****** Object:  Trigger [dbo].[Pers_Pers_Presupuestos_UTrig]    Script Date: 08/07/2015 14:27:27 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE TRIGGER [dbo].[Pers_Pers_Presupuestos_UTrig]
   ON  [dbo].[Pers_Presupuestos] 
   FOR UPDATE
AS 
BEGIN
