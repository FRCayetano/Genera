...
/****** Object:  Trigger [dbo].[Pers_Pers_Presupuestos_Gastos_UTrig]    Script Date: 08/07/2015 14:30:10 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE TRIGGER [dbo].[Pers_Pers_Presupuestos_Gastos_UTrig]
   ON  [dbo].[Pers_Presupuestos_Gastos] 
   FOR UPDATE
AS 
BEGIN
