...
/****** Object:  Trigger [dbo].[Pers_Pers_Presupuestos_Equipos_Empleados_UTrig]    Script Date: 08/07/2015 14:28:24 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE TRIGGER [dbo].[Pers_Pers_Presupuestos_Equipos_Empleados_UTrig]
   ON  [dbo].[Pers_Presupuestos_Equipos_Empleados] 
   FOR UPDATE
AS 
BEGIN
