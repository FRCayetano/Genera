USE [GENERA]
GO
/****** Object:  Trigger [dbo].[Pers_Pers_Presupuestos_Equipos_UTrig]    Script Date: 08/07/2015 14:27:53 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER TRIGGER [dbo].[Pers_Pers_Presupuestos_Equipos_UTrig]
   ON  [dbo].[Pers_Presupuestos_Equipos] 
   FOR UPDATE
AS 
BEGIN
