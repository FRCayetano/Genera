...
/****** Object:  Trigger [dbo].[Pers_Pers_Presupuestos_Equipos_GastosStaff_UTrig]    Script Date: 08/07/2015 14:29:09 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE TRIGGER [dbo].[Pers_Pers_Presupuestos_Equipos_GastosStaff_UTrig]
   ON  [dbo].[Pers_Presupuestos_Equipos_GastosStaff] 
   FOR UPDATE
AS 
BEGIN
