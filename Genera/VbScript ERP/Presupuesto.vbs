...
'  oShell.SendKeys "% x'
  ...
  If gcn.IdDepartamento <> 1 Then
    gForm.Controls("Pers_Cerrado").Visible = False
  End If
...
Sub Initialize()
  ...
  gForm.move  4500, 1000, 20000, 14200
  'gForm.Width=20000
  'gForm.Height = 14200
  CargaControles
...
Sub CargaEquiposEmpleados()
  ...
  With lPnl3  
    .Object.AutoSize = 3 'ssChildToPanel  
    .Visible = True 
    gForm.Controls("Pest11").InsertItem 4, "Equipos Empleados", .Object.Hwnd, 170
  End With  
...
Sub CargaIngresosVsGastos()
  ...
  With lPnl5  
    .Object.AutoSize = 3 'ssChildToPanel  
    .Visible = True 
    gForm.Controls("Pest11").InsertItem 10, "Ingresos Vs Gastos", .Object.Hwnd, 170
  End With
